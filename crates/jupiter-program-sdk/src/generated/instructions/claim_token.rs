...
impl ClaimToken {
  pub fn instruction(&self, args: ClaimTokenInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ClaimTokenInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl ClaimTokenBuilder {
  pub fn new() -> Self {
    ...
    pub fn program_authority(&mut self, program_authority: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn program_token_account(&mut self, program_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn mint(&mut self, mint: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn associated_token_token_program(&mut self, associated_token_token_program: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = ClaimToken {
                              payer: self.payer.expect("payer is not set"),
                                        ...
                                        program_token_account: self.program_token_account.expect("program_token_account is not set"),
                                        destination_token_account: self.destination_token_account.expect("destination_token_account is not set"),
                                        mint: self.mint.expect("mint is not set"),
                                        associated_token_token_program: self.associated_token_token_program.expect("associated_token_token_program is not set"),
...
impl<'a, 'b> ClaimTokenCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn program_authority(&mut self, program_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn program_token_account(&mut self, program_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn mint(&mut self, mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn associated_token_token_program(&mut self, associated_token_token_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          program_token_account: self.instruction.program_token_account.expect("program_token_account is not set"),
          ...
          associated_token_token_program: self.instruction.associated_token_token_program.expect("associated_token_token_program is not set"),
