...
impl CreateProgramOpenOrders {
  pub fn instruction(&self, args: CreateProgramOpenOrdersInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateProgramOpenOrdersInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = CreateProgramOpenOrdersInstructionData::new().try_to_vec().unwrap();
...
impl<'a, 'b> CreateProgramOpenOrdersCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn open_orders(&mut self, open_orders: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn program_authority(&mut self, program_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn dex_program(&mut self, dex_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          open_orders: self.instruction.open_orders.expect("open_orders is not set"),
                  
          payer: self.instruction.payer.expect("payer is not set"),
                  
          program_authority: self.instruction.program_authority.expect("program_authority is not set"),
                  
          dex_program: self.instruction.dex_program.expect("dex_program is not set"),
