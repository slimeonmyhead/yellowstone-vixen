...
impl SharedAccountsRouteWithTokenLedger {
  pub fn instruction(&self, args: SharedAccountsRouteWithTokenLedgerInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SharedAccountsRouteWithTokenLedgerInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = SharedAccountsRouteWithTokenLedgerInstructionData::new().try_to_vec().unwrap();
...
impl SharedAccountsRouteWithTokenLedgerBuilder {
  pub fn new() -> Self {
    ...
    pub fn token_program(&mut self, token_program: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn program_authority(&mut self, program_authority: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn source_token_account(&mut self, source_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn program_source_token_account(&mut self, program_source_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.program_source_token_account = Some(program_source_token_account);
                    self
    }
            #[inline(always)]
    pub fn program_destination_token_account(&mut self, program_destination_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
    pub fn platform_fee_account(&mut self, platform_fee_account: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
            ...
            /// `[optional account]`
#[inline(always)]
    pub fn token2022_program(&mut self, token2022_program: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SharedAccountsRouteWithTokenLedger {
                              token_program: self.token_program.expect("token_program is not set"),
                                        ...
                                        program_source_token_account: self.program_source_token_account.expect("program_source_token_account is not set"),
                                        program_destination_token_account: self.program_destination_token_account.expect("program_destination_token_account is not set"),
          ...
          let args = SharedAccountsRouteWithTokenLedgerInstructionArgs {
                                                              id: self.id.clone().expect("id is not set"),
                                                                  ...
                                                                  quoted_out_amount: self.quoted_out_amount.clone().expect("quoted_out_amount is not set"),
...
impl<'a, 'b> SharedAccountsRouteWithTokenLedgerCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn token_program(&mut self, token_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn program_authority(&mut self, program_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn source_token_account(&mut self, source_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn program_source_token_account(&mut self, program_source_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.program_source_token_account = Some(program_source_token_account);
                    self
    }
      #[inline(always)]
    pub fn program_destination_token_account(&mut self, program_destination_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.program_destination_token_account = Some(program_destination_token_account);
                    self
    }
      #[inline(always)]
...
#[inline(always)]
    pub fn platform_fee_account(&mut self, platform_fee_account: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn token2022_program(&mut self, token2022_program: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = SharedAccountsRouteWithTokenLedgerInstructionArgs {
                                                              id: self.instruction.id.clone().expect("id is not set"),
                                                                  ...
                                                                  quoted_out_amount: self.instruction.quoted_out_amount.clone().expect("quoted_out_amount is not set"),
        ...
        __program: self.instruction.__program,
          ...
          program_source_token_account: self.instruction.program_source_token_account.expect("program_source_token_account is not set"),
                  
          program_destination_token_account: self.instruction.program_destination_token_account.expect("program_destination_token_account is not set"),
