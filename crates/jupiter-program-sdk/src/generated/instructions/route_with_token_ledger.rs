...
impl RouteWithTokenLedger {
  pub fn instruction(&self, args: RouteWithTokenLedgerInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RouteWithTokenLedgerInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = RouteWithTokenLedgerInstructionData::new().try_to_vec().unwrap();
...
impl RouteWithTokenLedgerBuilder {
  pub fn new() -> Self {
    ...
    pub fn user_transfer_authority(&mut self, user_transfer_authority: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn user_source_token_account(&mut self, user_source_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.user_source_token_account = Some(user_source_token_account);
                    self
    }
            #[inline(always)]
    pub fn user_destination_token_account(&mut self, user_destination_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.user_destination_token_account = Some(user_destination_token_account);
                    self
    }
            /// `[optional account]`
#[inline(always)]
    pub fn destination_token_account(&mut self, destination_token_account: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = RouteWithTokenLedger {
                              token_program: self.token_program.expect("token_program is not set"),
                                        ...
                                        user_source_token_account: self.user_source_token_account.expect("user_source_token_account is not set"),
                                        user_destination_token_account: self.user_destination_token_account.expect("user_destination_token_account is not set"),
...
impl<'a, 'b> RouteWithTokenLedgerCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn user_transfer_authority(&mut self, user_transfer_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn user_source_token_account(&mut self, user_source_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_source_token_account = Some(user_source_token_account);
                    self
    }
      #[inline(always)]
    pub fn user_destination_token_account(&mut self, user_destination_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_destination_token_account = Some(user_destination_token_account);
                    self
    }
      /// `[optional account]`
#[inline(always)]
    pub fn destination_token_account(&mut self, destination_token_account: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          user_source_token_account: self.instruction.user_source_token_account.expect("user_source_token_account is not set"),
                  
          user_destination_token_account: self.instruction.user_destination_token_account.expect("user_destination_token_account is not set"),
